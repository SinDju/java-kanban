...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Task task1 = new Task("таск1", "задача таска1", Status.NEW, 15, "11.01.2023,22:36");
        ...
        Subtask subtask1 = new Subtask("субстаск1 эпика1", "задача субтаска1", Status.NEW, 34, "11.01.2023,19:36", epicId1);
        Subtask subtask2 = new Subtask("субстаск2 эпика1", "задача субтаска2", Status.NEW, 15, "11.01.2023,21:36", epicId1);
        Subtask subtask3 = new Subtask("субстаск3 эпика1", "задача субтаска3", Status.NEW, 15, "11.01.2023,20:36", epicId1);
        ...
        System.out.println(taskManager.getEpic(epicId1).getStartTime());
        System.out.println(taskManager.getEpic(epicId1).getEndTime());
        Subtask updateSubtask1 = new Subtask("обновленный субстаск1 эпика1", "задача субтаска1",
                Status.DONE, 34, "11.01.2023,19:36", epicId1);
